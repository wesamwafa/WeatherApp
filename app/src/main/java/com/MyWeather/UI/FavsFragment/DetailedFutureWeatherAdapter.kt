...
import com.MyWeather.UI.FavsFragment.DetailedFutureWeatherItem
import com.MyWeather.myweather.R
import com.bumptech.glide.Glide
import kotlinx.android.synthetic.main.detailedfutureweatheritem.view.*


class DetailedFutureItemAdapter(private val itemList: List<DetailedFutureWeatherItem>, var context: Context) :
    RecyclerView.Adapter<DetailedFutureItemAdapter.ItemViewHolder>() {
